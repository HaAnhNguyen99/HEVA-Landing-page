...
export default {
  ...
  theme: {
    extend: {
      colors: {
        lightYellow: '#FDFDF1', // Changed from 'white' to 'lightYellow'
        primary: '#39442B',
        secondary: '#39442B33',
        yellow: '#FAFE86',
        gray: '#999999',
      ...
      fontFamily: {
        ...
        Editorial: ['Editorial-Regular', 'sans-serif'],
        Fraktion: ['Fraktion', 'sans-serif'],
        EditorialNew: ['EditorialNew', 'sans-serif'],
        EditorialItalic: ['Editorial-Italic', 'sans-serif'],
        EditorialUltralight: ['Editorial-Ultralight', 'sans-serif'],
      },
    },
  },
  plugins: [
